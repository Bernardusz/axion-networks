...
const LoginPage = () => {
	...
	useHead({
		...
		meta: [
			{ name: "description", content: "Login to your account | A VPS deployment for you to deploy your app." },
			{ name: "viewport", content: "width=device-width, initial-scale=1" },
			{ name: "robots", content: "index, follow" },

			// Open Graph (Social sharing)
			{ property: "og:title", content: "Login | Axion Networks" },
			{ property: "og:description", content: "Login to your account | A VPS deployment for you to deploy your app." },
			{ property: "og:type", content: "website" },
			// Twitter Card
			{ name: "twitter:card", content: "summary_large_image" },
			{ name: "twitter:title", content: "Login | Axion Networks" },
			{ name: "twitter:description", content: "Login to your account | A VPS deployment for you to deploy your app." },
		],
		link: [
